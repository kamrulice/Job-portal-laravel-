...
@section('content')
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header text-center">{{ __('Employer Register') }}</div>
                        ...
                        <form method="POST" action="{{ route('employer/register') }}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input id="name" type="hidden" name="user_type" value="employer" class="form-control @error('cname') is-invalid @enderror" >
